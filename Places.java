...
public class Places extends MapsJava {
    ...
    private String[][] getNodesPlaces(ArrayList<NodeList> nodes){
     ...
     private URL createURL(double latitude, double longitude,int radius,
        ...
        String _namePlace=""; 
            _namePlace="&name=" + URLEncoder.encode("utf-8");
        ...
        URL urlReturn=new URL(_location + _radius + _namePlace +
     ...
     */
        ...
        public String[][] getPlaces(double latitude, double longitude,int radius,
            ArrayList<String> types) throws UnsupportedEncodingException, MalformedURLException{
        URL url=createURL(latitude,longitude,radius,types);
        try {
